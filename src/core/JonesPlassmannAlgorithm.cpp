...
namespace {
    std::mutex mtx;
    void JPWorker(std::vector<Vertex> &vertices, std::unordered_set<int>& U, std::shared_ptr<std::vector<int>> r_p,
                  const std::unordered_set<int>::const_iterator U_begin, const std::unordered_set<int>::const_iterator U_end,
